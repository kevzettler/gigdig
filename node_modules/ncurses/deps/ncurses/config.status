...
config_files=" include/MKterm.h.awk include/curses.head:include/curses.h.in include/ncurses_dll.h include/termcap.h include/unctrl.h   include/Makefile ncurses/Makefile panel/Makefile menu/Makefile form/Makefile misc/Makefile c++/Makefile misc/run_tic.sh:misc/run_tic.in misc/ncurses-config:misc/ncurses-config.in man/ncursesw6-config.1:man/MKncu_config.in Makefile"
...
ac_cs_version="\
config.status
configured by configure, generated by GNU Autoconf 2.52.20101002,
  with options \"--without-debug --without-tests --without-progs --without-ada --without-manpages --enable-widec --enable-ext-colors\"
...
do
  ...
  *) # This is not an option, so the user has probably given explicit
  ...
  -recheck | --recheck | --rechec | --reche | --rech | --rec | --re | --r)
    echo "running /bin/sh configure " --without-debug --without-tests --without-progs --without-ada --without-manpages --enable-widec --enable-ext-colors " --no-create --no-recursion"
    exec /bin/sh configure --without-debug --without-tests --without-progs --without-ada --without-manpages --enable-widec --enable-ext-colors --no-create --no-recursion ;;
  --version | --vers* | -V )
...
LIB_NAME="ncurses"
LIB_SUBSETS="termlib+ext_tinfo+base+widechar+ext_funcs"
LIB_SUFFIX="w"
LIB_TRACING="DEBUG"
LN_S="ln -s -f"
MAKE_TERMINFO=""
...
SRC_SUBDIRS=" include ncurses panel menu form misc c++"
...
s,@includedir@,${prefix}/include/ncursesw,;t t
...
s,@LIBS@,,;t t
s,@top_builddir@,/Users/kevisazombie/Projects/Web/gigdig/node_modules/ncurses/deps/ncurses,;t t
s,@EGREP@,grep -E,;t t
s,@NCURSES_MAJOR@,5,;t t
s,@NCURSES_MINOR@,8,;t t
s,@NCURSES_PATCH@,20110226,;t t
s,@cf_cv_rel_version@,6.0,;t t
s,@cf_cv_abi_version@,6,;t t
s,@cf_cv_builtin_bool@,1,;t t
s,@cf_cv_header_stdbool_h@,1,;t t
s,@cf_cv_type_of_bool@,unsigned char,;t t
s,@build@,x86_64-apple-darwin11.2.0,;t t
s,@build_cpu@,x86_64,;t t
s,@build_vendor@,apple,;t t
s,@build_os@,darwin11.2.0,;t t
s,@host@,x86_64-apple-darwin11.2.0,;t t
s,@host_cpu@,x86_64,;t t
s,@host_vendor@,apple,;t t
s,@host_os@,darwin11.2.0,;t t
s,@target@,x86_64-apple-darwin11.2.0,;t t
s,@target_cpu@,x86_64,;t t
s,@target_vendor@,apple,;t t
s,@target_os@,darwin11.2.0,;t t
s,@CC@,gcc,;t t
s,@CFLAGS@,-O2 --param max-inline-insns-single=1200  -no-cpp-precomp,;t t
s,@LDFLAGS@, -Wl,-search_paths_first,;t t
s,@CPPFLAGS@,  -D_DARWIN_C_SOURCE -D_XOPEN_SOURCE_EXTENDED -DNDEBUG -I. -I../include -I${includedir},;t t
s,@ac_ct_CC@,gcc,;t t
s,@EXEEXT@,,;t t
s,@OBJEXT@,o,;t t
s,@CPP@,gcc -E,;t t
...
s,@ac_pt_PKG_CONFIG@,/usr/local/bin/pkg-config,;t t
...
s,@CXX_G_OPT@,-g,;t t
s,@LD_MODEL@,,;t t
s,@CC_SHARED_OPTS@,-dynamic,;t t
s,@LD_RPATH_OPT@,,;t t
s,@LD_SHARED_OPTS@,,;t t
s,@MK_SHARED_LIB@,${CC} ${CFLAGS} -dynamiclib -install_name ${libdir}/`basename $@` -compatibility_version ${ABI_VERSION} -current_version ${ABI_VERSION} -o $@,;t t
s,@LINK_PROGS@,,;t t
s,@LINK_TESTS@,,;t t
s,@EXTRA_LDFLAGS@,,;t t
s,@LOCAL_LDFLAGS@,,;t t
...
s,@TERMINFO_DIRS@,/usr/local/share/terminfo,;t t
s,@TERMINFO@,/usr/local/share/terminfo,;t t
s,@MAKE_TERMINFO@,,;t t
...
s,@ACPPFLAGS@,-I. -I../include -I../../include  -I${includedir},;t t
...
s,@TICS_ARGS@,-L../lib -lncursesw,;t t
s,@TINFO_ARG_SUFFIX@,ncursesw,;t t
s,@TINFO_DEP_SUFFIX@,,;t t
s,@TINFO_LIB_SUFFIX@,,;t t
s,@TINFO_ARGS@,-L../lib -lncursesw,;t t
s,@TINFO_ARGS2@,-L../../lib -lncursesw,;t t
s,@LDFLAGS_STATIC@,,;t t
s,@LDFLAGS_SHARED@,,;t t
s,@WITH_OVERWRITE@,no,;t t
s,@TICS_LIST@,,;t t
s,@TINFO_LIST@,,;t t
s,@SHLIB_LIST@,,;t t
s,@NCURSES_TREE@,,;t t
...
s,@NCURSES_SHLIB2@,sh $(top_srcdir)/misc/shlib,;t t
s,@HAVE_TCGETATTR@,1,;t t
s,@HAVE_TERMIO_H@,0,;t t
s,@HAVE_TERMIOS_H@,1,;t t
s,@MAKE_PC_FILES@,#,;t t
s,@cross_compiling@,no,;t t
s,@TIC_PATH@,/usr/bin/tic,;t t
s,@MAKE_TESTS@,#,;t t
CEOF
